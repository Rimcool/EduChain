    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h1 class="text-2xl font-bold mb-6">Manage Universities</h1>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">COMSATS University</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Engineering & Technology</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <a href="#" class="text-red-600 hover:text-red-900">Blacklist</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
