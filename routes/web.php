...
Route::middleware(['auth', 'role:super_admin'])->prefix('admin')->group(function () {
    ...
    Route::post('/universities/{id}/approve',   [AdminController::class, 'approve'])->name('admin.universities.approve');
    Route::post('/universities/{id}/blacklist', [AdminController::class, 'blacklist'])->name('admin.universities.blacklist');
    Route::post('/universities/{id}/unblacklist',[AdminController::class,'unblacklist'])->name('admin.universities.unblacklist');
